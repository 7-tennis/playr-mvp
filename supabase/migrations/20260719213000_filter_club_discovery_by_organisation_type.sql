-- Club discovery is a club-specific surface. Hybrid club/academy organisations
-- remain eligible because they explicitly include the club capability; schools,
-- districts and standalone academies must use their own product surfaces.
...
begin
  ...
  where venue.status = 'active'
    ...
    and venue.organisation_type in ('club', 'club_academy')
    and (
